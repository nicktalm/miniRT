...
SRCDIR = ./src
OBJDIR = ./obj
SRC = $(addprefix $(SRCDIR)/, main.c transformation.c cylinder.c check_hit.c multi_threading.c img_creation.c init_data.c key_actions.c vec_calc.c check_file.c error.c parsing.c helper.c parsing_obj.c parsing_helper.c helper_2.c)
