...
/*   Updated: 2024/08/30 12:43:36 by ntalmon          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	parse_light(t_data *data, char **line)
{
	...
	if (data->set.light.brightness < 0 || data->set.light.brightness > 1)
		error("Brightness must be between 0 and 1\n");
